%Modeling_VSP_tubewave_Caliper_Change
% S. Minato
...
%% This version of the code uses modeling parameters designed for a
%% homogeneous elastic medium with a step-like radius change
...
Vpvec=[4000 4000 4000 4000]; % size n. P-wave velocity at each layer (m/s)
Vsvec=[2000 2000 2000 2000]; % size n. S-wave velocity at each layer (m/s)
Rhovec=[2500 2500 2500 2500]; %Bulk density at each layer (kg/m3)
zn_org=[-10 0 1]; % size n-1. The depth of boundaries (m). 
rn=[0.055 0.055 0.065 0.065]; %size n. Borehole radius (m)
